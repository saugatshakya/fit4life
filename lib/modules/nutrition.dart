  ...
  Widget build(BuildContext context) {
    return Container(
      child: Center(
          ...
          SizedBox(height:10),
          Container(child: Text(nutrition.name,style: TextStyle(color:Colors.white,fontSize: 28,height:3,fontWeight:FontWeight.w700,fontFamily: 'Heatwood'))),
          SizedBox(height:10),
          ...
          Expanded(
              ...
              Container(width:MediaQuery.of(context).size.width,height:260,margin: EdgeInsets.only(top:5),child: 
              Column(children:[
